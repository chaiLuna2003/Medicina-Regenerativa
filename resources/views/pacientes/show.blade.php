        ...
        <div
            ...
            <div
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Actualiza la información personal del paciente.
                    </p>
                </div>
                ...
                <div class="space-y-5 px-6 py-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="nombre"
                            type="text"
                            value="{{ old('nombre', $pacientes->nombre) }}"
                            required
                            maxlength="255"
                            class="block w-full rounded-xl
                                   border-slate-300 text-sm
                    ...
                    <div>
                        ...
                        <input
                            ...
                            name="apellido"
                            type="text"
                            value="{{ old('apellido', $pacientes->apellido) }}"
                            required
                            maxlength="255"
                            class="block w-full rounded-xl
                                   border-slate-300 text-sm
               ...
               focus:ring-blue-500">
                    ...
                    <div
                        ...
                        <p class="text-xs leading-5 text-blue-700">
                            La edad se recalcula automáticamente
                            utilizando la fecha de nacimiento.
                        </p>
                    </div>
                </div>
