...
$saludo = match (true) {
$horaActual >= 6 && $horaActual < 12=> 'Buenos días',
    $horaActual >= 12 && $horaActual < 19=> 'Buenas tardes',
        ...
        <head>
            ...
            <style>
                ...
                .login-orb-primary {
                    animation: login-float-primary 14s ease-in-out infinite;
                    will-change: transform;
                }

                .login-orb-secondary {
                    animation: login-float-secondary 18s ease-in-out infinite;
                    will-change: transform;
                }

                .login-ring-primary {
                    animation: login-ring-pulse 10s ease-in-out infinite;
                    transform-origin: center;
                    will-change: transform, opacity;
                }

                .login-ring-secondary {
                    animation: login-ring-pulse 10s ease-in-out 2s infinite;
                    transform-origin: center;
                    will-change: transform, opacity;
                }

                @keyframes login-float-primary {
                ...
                @keyframes login-float-secondary {
        ...
        <body class="min-h-screen bg-white text-slate-900 antialiased">
            ...
            <main class="grid min-h-screen lg:grid-cols-[1.05fr_0.95fr]">
                ...
                <section
                    ...
                    {{-- Decoraciones --}}
                    <div
                        class="login-orb-primary pointer-events-none absolute -left-32 -top-32 h-[420px] w-[420px] rounded-full bg-teal-400/20 blur-3xl"></div>

                    <div
                        class="login-orb-secondary pointer-events-none absolute -bottom-44 -right-32 h-[520px] w-[520px] rounded-full bg-emerald-300/20 blur-3xl"></div>

                    <div
                        class="login-ring pointer-events-none absolute right-[10%] top-[16%] h-64 w-64 rounded-full border border-white/10"></div>

                    <div
                        class="login-ring pointer-events-none absolute right-[14%] top-[20%] h-48 w-48 rounded-full border border-white/10"></div>
                    ...
                    <div class="relative z-10 px-10 pb-10 xl:px-14 xl:pb-14">
                        <div class="max-w-2xl">
                            ...
                            <h1
                                ...
                                Control de Datos y expedientes Clínicos
                            </h1>
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between gap-4">
                                    ...
                                    <span
                                        ...
                                        <span
                                            class="h-2 w-2 rounded-full bg-emerald-300 ring-4 ring-emerald-300/10"></span>
                ...
                <section class="relative flex min-h-screen items-center justify-center bg-white px-5 py-10 sm:px-8 lg:px-12">
                    ...
                    {{-- Decoración móvil --}}
                    <div
                        class="pointer-events-none absolute -right-32 -top-32 h-72 w-72 rounded-full bg-teal-100/70 blur-3xl lg:hidden"></div>
                        ...
                        <form
                            ...
                            <div>
                                ...
                                <p class="mt-3 text-sm leading-5 text-slate-500">
                                    ...
                                    <a
                                        href="https://wa.me/5215642859995?text=Hola%2C%20tengo%20problemas%20para%20acceder%20a%20mi%20cuenta"
                                        target="_blank"
