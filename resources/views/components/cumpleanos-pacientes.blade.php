@props([
    'pacientes',
    'descripcion' => 'Hoy y próximos 7 días',
])
...
<section
    ...
    <button
        ...
        aria-controls="lista-cumpleanos-pacientes"
        class="flex w-full items-center justify-between gap-4
               px-4 py-4 text-left transition
               hover:bg-slate-50
               focus:outline-none focus:ring-2
               focus:ring-inset focus:ring-pink-300
               sm:px-6 sm:py-5">
        ...
        <span class="flex shrink-0 items-center gap-3">
            <span
                aria-label="{{ $pacientes->count() }}
                    pacientes con cumpleaños registrados"
            ...
            @empty
                <div class="px-4 py-10 text-center sm:px-6">
                    <p class="text-sm font-medium text-slate-600">
                        No hay pacientes con cumpleaños registrados.
                    </p>

                    <p class="mt-1 text-xs text-slate-400">
                        Aquí aparecerán los pacientes activos
