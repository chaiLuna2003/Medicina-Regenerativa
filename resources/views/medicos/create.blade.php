<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h2 class="text-xl font-semibold text-slate-900">Nuevo médico</h2>
                <p class="mt-1 text-sm text-slate-500">Vincula una cuenta médica y registra sus datos profesionales.</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="mx-auto max-w-2xl px-4 sm:px-6">
            ...
            <form action="{{ route('medicos.store') }}" method="POST"
                ...
                <div class="mt-8 flex flex-col-reverse gap-3 border-t border-slate-100 pt-6 sm:flex-row sm:justify-end">
                    ...
                    <button type="submit" class="rounded-lg bg-blue-600 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-700">Crear médico</button>
                </div>
            </form>
        </div>
    </div>
